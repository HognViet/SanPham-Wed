...
public class AdminController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            }else if(action.equals("listProfuct")){
                request.getRequestDispatcher("admin_sanpham_list.jsp").forward(request, response);
            }
            else if(action.equals("listOrder")){
                request.getRequestDispatcher("admin_donhang_list.jsp").forward(request, response);
            }
